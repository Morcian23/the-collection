    ...
    <main className="min-h-screen bg-cream flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-10 text-center pt-20">
        ...
        <motion.p
          ...
          className="font-panamera text-xs tracking-[0.35em] uppercase text-gray-soft mb-20 max-w-xs"
        >
        ...
        >
          {submitted ? (
            ...
            <>
              <p className="font-panamera text-xs tracking-[0.35em] uppercase text-gray-soft mb-8">
              ...
              <form onSubmit={handleSubmit} className="flex border-b border-sage/60">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="font-panamera text-xs tracking-[0.3em] uppercase text-gray-soft py-3 pl-6 hover:text-dark transition-colors duration-500 cursor-pointer disabled:opacity-40"
                >
                  {loading ? '...' : 'Notify Me'}
                </button>
              </form>
